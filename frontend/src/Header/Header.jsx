    ...
    <>
      <Container fluid className='m-0 p-0 px-4 head-container'>
        <Row className='m-0 py-0 px-4'>
          <Col xs={12} md={6} className="head-text d-flex flex-column flex-md-row gap-2 align-items-center justify-content-center justify-content-md-start m-0 p-0">
            <div className="d-flex align-items-center gap-2">
              <FiPhoneCall className="fs-5" />
              <span>989 803 1834 987 936 1093</span>
            </div>
            <div className="d-flex align-items-center gap-2">
          ...
          <Col xs={12} md={6} className="d-flex justify-content-center justify-content-md-end align-items-center gap-2 m-0 p-0 mt-2 mt-md-0">
