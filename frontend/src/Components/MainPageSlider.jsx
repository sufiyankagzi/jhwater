...
import Img1 from '../assets/banner/ban-1.png';
                ...
                <div>
                    <div className="slide-container">
                        ...
                        <div className="slide-text2">
                            <h2 className='' style={{color:"#192b52ff"}}>Let's Solve Water</h2>
                            <p className='text-info'>We Provide Sustainable</p>
                            <p className='text-info'> Water Management Solutions</p>
